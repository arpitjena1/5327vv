...
#define LEFT_MOTORS -15, -1,-2
#define RIGHT_MOTORS 4,5,6
#define GEARSET pros::E_MOTOR_GEAR_600 // RPM of chassis motors

// Ticks per inch
#define TPI  3525.89412388  			  // Encoder ticks per inch of forward robot movement
...
#define ENCODER_PORTS -8, -9, 0             // Port 0 for disabled,
...
#define SETTLE_TIME 60   // amount of time to count as settled
